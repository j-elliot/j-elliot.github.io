...
\address{717-398-1540 \\ elliot@alum.bucknell.edu} % Your phone number and email
...
\item Branching across departments, I collaborated with an electrical engineer to express her vision in code.
\item Primarily responsible for designing and implementing project goals in code.
\item Managed user testing and feedback in iterative design process.
\end{rSubsection}
...
\item Ranked third in Project Management at Phi Beta Lambda state conference 2015 
\end{rSection}

%----------------------------------------------------------------------------------------
\begin{rSection}{Relevant Courses}
\itab{\textbf{Core Courses}} \tab{}  \tab{\textbf{Other Courses}}
\\ \itab{Discrete Structures} \tab{}  \tab{Human Computer Interaction}
\\ \itab{Calculus III} \tab{}  \tab{Accounting I \& II} 
\\ \itab{Algorithms} \tab{}  \tab{Marketing} 
\\ \itab{Life, Computers \& Everything} \tab{} \tab{Applied Calculus for Business}
\\ \itab{Software Engineering and Design} \tab{} \tab{Linear Algebra}
